...
-- Add all missing columns to existing tables and ensure status columns remain VARCHAR(255)
...
-- Explicitly ensure status columns remain VARCHAR(255) to prevent type changes
ALTER TABLE vehicle_closure_entity
    ALTER COLUMN recollection_status TYPE VARCHAR(255);

ALTER TABLE vehicle_operation_entity
    ALTER COLUMN coupon_distribution_status TYPE VARCHAR(255),
    ALTER COLUMN deploying_status TYPE VARCHAR(255),
    ALTER COLUMN fund_raising_status TYPE VARCHAR(255),
    ALTER COLUMN operation_status TYPE VARCHAR(255);
