...
public interface InvestmentVehicleFinancierOutputPort {
    ...
    Page<Financier> viewAllFinancierInAnInvestmentVehicle(String investmentVehicleId, List<ActivationStatus> activationStatuses, Pageable pageRequest) throws MeedlException;
