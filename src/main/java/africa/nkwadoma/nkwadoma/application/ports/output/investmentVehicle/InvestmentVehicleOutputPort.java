...
public interface InvestmentVehicleOutputPort {
    ...
    Page<InvestmentVehicle> findAllInvestmentVehicleFinancierWasAddedTo(String id, InvestmentVehicle investmentVehicle, int pageSize, int pageNumber) throws MeedlException;
}
