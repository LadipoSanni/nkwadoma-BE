...
public interface DisbursementRuleUseCase {
    ...
    DisbursementRule editDisbursementRule(DisbursementRule disbursementRule) throws MeedlException;
    ...
    void removeDisbursementRuleFromLoan(DisbursementRule disbursementRule) throws MeedlException;
