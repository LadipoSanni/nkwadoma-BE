...
public class ErrorMessages {
    ...
    public static final String INVALID_LOAN_REFERRAL_STATUS = "Loan referral status must either be ACCEPTED or DECLINED";
    public static final String INVALID_LOAN_DECISION = "Loan decision must be either ACCEPTED or DECLINED";
}
