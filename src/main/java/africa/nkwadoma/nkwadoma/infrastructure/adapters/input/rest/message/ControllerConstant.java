...
public class ControllerConstant {
   ...
   public static final String  SET_MEEDL_OBLIGOR_LIMIT = "Setting of meedl's obligor loan limits.";
   public static final String  VIEW_MEEDL_OBLIGOR_LIMIT = "View meedl's obligor loan limits.";
   public static final String SET_MEEDL_OBLIGOR_LIMIT_DESCRIPTION = "Setting of meedl's general obligor loan limits. This action can only be done by the super admin";
   public static final String  VIEW_MEEDL_OBLIGOR_LIMIT_DESCRIPTION = "View meedl's general obligor loan limits.";
