...
public class InvestmentVehicleController {
    ...
    @PreAuthorize("hasRole('MEEDL_SUPER_ADMIN') or hasRole('MEEDL_ADMIN') "  + "or hasRole('PORTFOLIO_MANAGER_ASSOCIATE')"+
            "or hasRole('PORTFOLIO_MANAGER') or hasRole('FINANCIER')  or hasRole('COOPERATE_FINANCIER_ADMIN') or  " +
            "hasRole('COOPERATE_FINANCIER_SUPER_ADMIN')")
    ...
    @PreAuthorize("hasRole('MEEDL_SUPER_ADMIN') or hasRole('MEEDL_ADMIN') or hasRole('PORTFOLIO_MANAGER') " +"or hasRole('PORTFOLIO_MANAGER_ASSOCIATE')"+
            "or hasRole('COOPERATE_FINANCIER_ADMIN') or hasRole('FINANCIER') or  hasRole('COOPERATE_FINANCIER_SUPER_ADMIN')")
    ...
    @PreAuthorize("hasRole('MEEDL_SUPER_ADMIN') or hasRole('MEEDL_ADMIN') or hasRole('FINANCIER') or hasRole('PORTFOLIO_MANAGER') or hasRole('PORTFOLIO_MANAGER_ASSOCIATE') or hasRole('COOPERATE_FINANCIER_ADMIN') or  hasRole('COOPERATE_FINANCIER_SUPER_ADMIN')")
    ...
    @PreAuthorize("hasRole('MEEDL_SUPER_ADMIN') or hasRole('MEEDL_ADMIN') or hasRole('PORTFOLIO_MANAGER')  or hasRole('PORTFOLIO_MANAGER_ASSOCIATE')" +
            " or hasRole('COOPERATE_FINANCIER_SUPER_ADMIN') or hasRole('COOPERATE_FINANCIER_ADMIN')")
