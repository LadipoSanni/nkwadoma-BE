...
@Mapper(componentModel = "spring", uses = {UserIdentityMapper.class, BankDetailMapper.class}, nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
