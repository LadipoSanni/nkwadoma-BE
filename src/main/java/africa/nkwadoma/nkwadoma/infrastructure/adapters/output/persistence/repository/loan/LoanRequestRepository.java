...
public interface LoanRequestRepository extends JpaRepository<LoanRequestEntity, String> {
    ...
    SELECT 
        lr.id, 
        l.userIdentity.firstName, 
        l.userIdentity.lastName, 
        l.userIdentity.email, 
        l.userIdentity.phoneNumber, 
        l.userIdentity.alternateContactAddress,
        l.userIdentity.alternateEmail, 
        l.userIdentity.alternatePhoneNumber, 
        o.name, 
        l.id,
        cle.loaneeLoanDetail.initialDeposit, 
        c.startDate, 
        c.tuitionAmount, 
        c.name, 
        l.userIdentity.image,
        p.name, 
        n.id, 
        n.firstName, 
        n.lastName, 
        ...
        n.email, 
        n.phoneNumber, 
        n.nextOfKinRelationship,
        cle.loaneeLoanDetail.amountRequested, 
        lr.createdDate,
        l.userIdentity.gender, 
        l.userIdentity.maritalStatus,
        l.userIdentity.dateOfBirth, 
        l.userIdentity.residentialAddress, 
        l.userIdentity.nationality,
        l.userIdentity.stateOfOrigin, 
        l.userIdentity.stateOfResidence, 
        lr.status
