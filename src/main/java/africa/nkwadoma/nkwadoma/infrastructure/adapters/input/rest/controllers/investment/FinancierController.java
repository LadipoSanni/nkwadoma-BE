...
public class FinancierController {
    ...
    public  ResponseEntity<ApiResponse<?>> viewAllFinancier(@AuthenticationPrincipal Jwt meedlUser,
        ...
        Financier financier = Financier.builder().pageNumber(pageNumber).pageSize(pageSize).investmentVehicleId(investmentVehicleId).financierType(financierType).activationStatuses(activationStatuses).build();
    ...
    public  ResponseEntity<ApiResponse<?>> search(@AuthenticationPrincipal Jwt meedlUser,
                                                  ...
                                                  @RequestParam int pageSize,
                                                  @RequestParam(required = false) FinancierType financierType,
                                                  @RequestParam(required = false) List<ActivationStatus> activationStatuses,
                                                  @RequestParam(required = false) String investmentVehicleId
    ) throws MeedlException {
        Financier financier = Financier.builder().pageSize(pageSize).pageNumber(pageNumber).financierType(financierType).investmentVehicleId(investmentVehicleId).activationStatuses(activationStatuses).build();
