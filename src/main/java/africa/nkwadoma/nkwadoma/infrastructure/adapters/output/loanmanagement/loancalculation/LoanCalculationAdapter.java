package africa.nkwadoma.nkwadoma.infrastructure.adapters.output.loanmanagement.loancalculation;
...
@Slf4j
@Component
public class LoanCalculationAdapter implements LoanCalculationOutputPort {
