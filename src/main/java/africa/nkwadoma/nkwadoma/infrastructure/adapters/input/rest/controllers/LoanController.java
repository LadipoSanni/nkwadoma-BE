...
import africa.nkwadoma.nkwadoma.infrastructure.adapters.input.rest.data.request.education.ProgramsRequest;
...
public class LoanController {
    ...
    public ResponseEntity<ApiResponse<?>> viewAllPrograms(@AuthenticationPrincipal Jwt meedlUser, @Valid @RequestBody LoanProductViewAllRequest request) {
        Page<LoanProduct> loanProductPage = viewLoanProductUseCase.viewAllLoanProduct(request.getPageSize(), request.getPageNumber());
