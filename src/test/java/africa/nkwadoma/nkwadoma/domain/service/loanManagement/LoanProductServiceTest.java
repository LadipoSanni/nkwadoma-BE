...
class LoanProductServiceTest {
    ...
    void createLoanProductWithTheSameName(){
        ...
        try {
            createdLoanProduct = createLoanProductUseCase.createLoanProduct(loanProduct);
            assertThrows(MiddlException.class,()-> createLoanProductUseCase.createLoanProduct(loanProduct));
            createLoanProductUseCase.deleteLoanProductById(createdLoanProduct);
    ...
    void createLoanProductWithNullRequestEntity(){
        assertThrows(MiddlException.class, () -> createLoanProductUseCase.createLoanProduct(null));
    }
    @Test
    ...
    void deleteLoanProductWithNullRequest(){
        assertThrows(MiddlException.class, ()-> createLoanProductUseCase.deleteLoanProductById(null));
    }
    @Test
    void deleteLoanProductWithNullId(){
        loanProduct.setId(null);
        assertThrows(MiddlException.class, ()-> createLoanProductUseCase.deleteLoanProductById(loanProduct));
    }
}