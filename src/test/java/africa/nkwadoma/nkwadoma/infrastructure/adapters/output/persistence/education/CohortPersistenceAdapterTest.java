...
public class CohortPersistenceAdapterTest {
    ...
    void setUpOrg() {
        UserIdentity userIdentity = UserIdentity.builder()
                ...
                lastName("Benson Ayo").email("Fedral@example.com").createdBy("61fb3beb-f200-4b16-ac58-c28d737b546c").build();
        employeeIdentity = OrganizationEmployeeIdentity.builder()
                .meedlUser(userIdentity).build();
        organizationIdentity = OrganizationIdentity.builder().email("organization1@example.com")
